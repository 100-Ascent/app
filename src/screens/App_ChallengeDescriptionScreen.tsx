          ...
          <View style={{ flex: 1 }}>
            ...
            {currentTab === 0 ? (
              <View>
                ...
                <RoadMapCard roadMap={data.roadMap} roadmapOnPressHandler={onRoadmapPressHandler} />
              ...
              <View>
                <View style={{ padding: 10 }} />
                <CommonCard data={data.rewards[0]} imageOnPress={rewardImageOnPress} />
                <View style={{ padding: 10 }} />
                <CommonCard data={data.rewards[1]} imageOnPress={rewardImageOnPress} />
                <View style={{ padding: 10 }} />
                <CommonCard data={data.rewards[2]} imageOnPress={rewardImageOnPress} />
                <View style={{ padding: 10 }} />
